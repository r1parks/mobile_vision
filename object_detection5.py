...
if __name__ == "__main__":
    ...
    while status:
        ...
        output_img = numpy.copy(frame1)
        output_img[:] = 0
        add_optical_flow_vectors(output_img, imgfeatures1, next_points)
        ...
        add_clustering_points(output_img, points_of_interest, labels, centers)
